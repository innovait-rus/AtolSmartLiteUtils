...
{
	L"НачатьОтслеживаниеСобытий",
	L"ОстановитьОтслеживаниеСобытий"
};

static const wchar_t g_ComponentNameAddIn[] = L"AtolSmartLiteUtils";
...
bool AddInNative::CallAsProc(const long lMethodNum, tVariant* paParams, const long lSizeArray)
{
	switch (lMethodNum)
	{
		...
		case eMethStartEventsWatch: {
			javaMainApp.startEventsWatch();
			return true;
		}
		case eMethStopEventsWatch: {
            javaMainApp.stopEventsWatch();
			return true;
		}
		default:
			return false;
